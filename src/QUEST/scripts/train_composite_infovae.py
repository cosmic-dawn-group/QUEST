...
import QUEST.plots.qa_plots as qa
from QUEST import LOCAL_PATH as local_path
from QUEST import mlconfig as cfg
from QUEST.models.info_vae import InfoSpecVAE
from QUEST.utils import load as ld
from QUEST.utils import spec_dataset as sd
from QUEST.utils import train_utils as tu
...
logger = logging.getLogger("QUEST.train")
...
#     do
#         /Users/francesco/uvp/QUEST/src/QUEST/scripts/train_composite_infovae.py ...args... -lr $lr -reg_w $reg_w
#     done
# done
